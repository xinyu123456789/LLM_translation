...
# 訓練集和驗證集要用 json 格式
train_dataset = load_dataset('json', data_files='train_io_1000.jsonl', split='train') # data_files 填檔名，記得副檔名要用 jsonl
eval_dataset = load_dataset('json', data_files='eval_io_300.jsonl', split='train') # data_files 填檔名，記得副檔名要用 jsonl
